...
<p>O esquema do banco de dados segue as seguintes relações:</p>

- Ninja: Contém atributos como id, nome, idade, email e rank.
- Missão: Contém atributos como id, título e descrição.

<p>Um Ninja pode ter apenas uma Missão, mas uma Missão pode ser atribuída a vários Ninjas.</p>

## Configuração
- Clone o repositório: git clone https://github.com/cristianandriel/CadastroDeNinjas.git
